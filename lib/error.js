...
const AuthorizationRequiredError = new Error();
AuthorizationRequiredError.statusCode = 401;
AuthorizationRequiredError.name = 'Error';
AuthorizationRequiredError.message = 'Authorization Required';
...
module.exports.AuthorizationRequiredError = AuthorizationRequiredError;
